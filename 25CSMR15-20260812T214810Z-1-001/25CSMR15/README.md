...
## When You Send Me The IPs

Once you send the IPs of machines 2 and 3, I can do two more things for you:

- The IPs are already filled into the machine env files.
- Use [templates/hosts.final](/Users/prasoonk/Projects/laborg/templates/hosts.final) on all 3 machines.
